...
// Query pertama: Ambil event berdasarkan username dari tabel pendaftar
$queryid = "SELECT event FROM pendaftar WHERE username = '$user_id'";
    ...
    <header class="navbar">
      <div class="nav-wrapper">
        ...
        <ul>
          ...
          <li><a href="index2.php#tentang">Tentang</a></li>
          <li><a href="index2.php#webinar">Webinar</a></li>
          <li><a href="event_saya.php">Jadwal</a></li>
          <li><a href="index2.php#kontak">Kontak</a></li>
        </ul>
        ...
        <div class="card-grid">
          ...
          if ($resultid && mysqli_num_rows($resultid) > 0) {
              while ($row = mysqli_fetch_assoc($resultid)) {
                  ...
                  // Query kedua: Ambil detail event dari tabel event berdasarkan event_id
                  $query = "SELECT * FROM event WHERE id = '$event_id'";
                  $result = mysqli_query($conn, $query);

                  // Cek jika query kedua berhasil dan ada hasilnya
            ...
            <div class="card-content">
                ...
                <div class="date-time">
                  ...
                  <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <p><?php echo htmlspecialchars($event['tanggal']); ?></p>
                  </div>
                  <div class="time">
          ...
          <?php 
              ...
              echo '<div class="no-event-message">Anda belum mendaftar untuk webinar apapun.</div>';
          }
          ?>
        </div>
      </div>
